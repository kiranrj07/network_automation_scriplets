...
__release__ = "0.4"
__version__ = "$Rev: 141 $ $LastChangedDate: 2010-04-12 18:59:21 +1000 (Mon, 12 Apr 2010) $"
...
def path_references_application(path, apps):
    ...
    """
    # assume separator is /
    nodes = [_f for _f in path.split('/') if _f]
...
def _run_app(rootapp, apps, ecb):
    ecb_dict = ECBDictAdapter(ecb)
    path_info = interpretPathInfo(ecb_dict, list(apps.keys()))
